...
> **实现状态**：部分兑现。Piece①～⑤完成进程内基础、事实端口、准入、真实执行接管及只读批次的协议配对；持久保护、副作用资源准入及跨重启恢复仍未完成。实际测试与后续范围见[当前计划](../../../docs/todo.md#c-02-implementation-pieces)及[对齐表](../../../docs/ALIGNMENT.md)。
