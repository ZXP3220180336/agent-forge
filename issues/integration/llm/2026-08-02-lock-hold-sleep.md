...
> **演进注**：原声称的回归测试 `test_bucket_wait_does_not_block_others` / `test_bucket_cancel_does_not_corrupt_state` 于修复时未落盘，2026-09-02 文档审查确认后补录于 `tests/unit/test_reservation_limiter.py`（锁外 sleep 语义锚定）。
